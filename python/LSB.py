...
plt.figure()
plt.plot(ours[:,0], ours[:,1], label='linear stability boundary')
...
plt.errorbar(coles_H1[:,0]*ofactor, coles_H1[:,1]*ifactor, xerr=c_xerr,yerr=c_yerr, label='Coles (1965, fig2a)')
