...
for folder in folders:
    ...
    r_vs_v_plane_avg = datafile['tasks/v_tot'][-100: ,0,:,:].mean(axis=0)
...
plt.title("L2 norm vs. $\Lambda$ " + str(prefix)[0:-1])
plt.xlabel("$\Lambda$")
plt.ylabel("L2 norm")
plt.tight_layout()
plt.style.use('prl')
...
plot_file_name = 'L2norm_' + str(prefix)[0:-1] + '.png'
...
# plt.title("L2 norm vs. $\Lambda$ SemiLogY " + str(prefix)[0:-1])
# plt.xlabel("$\Lambda$")
# plt.ylabel("L2 norm")
# plt.tight_layout()
# plt.style.use('prl')
